...
/**
 * <p>
 * This {@link org.apache.commons.pipeline.Pipeline$Stage Stage} is used to
 * recursively find (non-directory) files that match the specified regex.
 * </p>
 * 
 * <p>
...
public class FileFinderStage extends BaseStage {
	...
	/**
	 * This method inspects a File object to determine if it matches this
	 * FileFinder's filePattern property. If the File represents a directory, it
	 * recursively searches that directory and all subdirectories for matching
	 * files. Matched files are placed on the next stage's queue.
	 */
	public void process(Object obj) {
		// File file = (obj instanceof String) ? new File((String) obj) : (File)
		// obj;
		...
		if (!file.exists()) {
			...
			log.debug(file.getName() + " is a directory, processing "
			...
			this.emit(new FileBundle(file, fb.getDate()));
		}
	}
