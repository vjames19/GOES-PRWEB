 ...
 * 
 * <p>
 * To send an email just construct the object and select from one of the two
...
public class Emailer {
	 ...
	 * @param message
	 *            Message to write in the email
	 * @throws EmailException
	 *             if the send failed
	 * @throws MalformedURLException
	 *             the file being attached is a bad file
	 */
	...
	private Email initializeEmail(Email email, String subject)
			throws EmailException {
		if (subject == null) {
			subject = "";
		}
		...
		email.setAuthenticator(new DefaultAuthenticator(emailProps.getFrom(),
	 ...
	 *             the file being attached is a bad file
	 */
	public void sendEmailWithAttachment(String subject, String message,
			File file) throws EmailException, MalformedURLException {
